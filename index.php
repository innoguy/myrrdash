<?php
    ...
    if (!isset($_GET['controller']) || empty($_GET['controller']) || !array_key_exists($_GET['controller'], $Controllers)) {
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <?php
                                print("<a class=\"dropdown-item\" href=\"?controller=" . $DefaultController . "&category=" . $CurrentCategory . "\">Default</a>");
                            ?>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
